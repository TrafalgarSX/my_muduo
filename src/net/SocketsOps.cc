...
int sockets::accept(int sockfd, struct sockaddr_in6* addr)
{
  ...
  if (connfd < 0)
  {
    ...
    switch (savedErrno)
    {
      ...
      case EOPNOTSUPP:
        // unexpected errors
        SPDLOG_ERROR("unexpected error of ::accept {}", strerror(savedErrno));
        break;
      default:
        SPDLOG_ERROR("unknown error of ::accept {}", strerror(savedErrno));
        break;
    }
  }
  return connfd;
